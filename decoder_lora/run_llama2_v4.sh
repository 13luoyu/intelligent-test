...
# nohup bash run_llama2_v4.sh >../log/run_llama2_lora_v4.log &

# 模型保存目录、预测数据目录、训练数据文件、验证数据文件
output_dir=./output/v4/llama2
predict_dir=./predict_data/v4/llama2
train_files=../data/data_for_LLM_v4/llama2/train_v4.csv
validation_files=../data/data_for_LLM_v4/llama2/validate_v4.csv
all_files=../data/data_for_LLM_v4/llama2/ir_all_v4.csv
