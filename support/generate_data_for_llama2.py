...
if __name__ == "__main__":
    ...
    # v2
    datas = json.load(open("../data/data_for_LLM_v2/ir_annotation_v2_for_train.json", "r", encoding="utf-8"))
    s = generate_llm_chat_data_v2(datas)
    with open("../data/data_for_LLM_v2/ir_train_v2.csv", "w", encoding="utf-8") as f:
        f.write(s)
    datas = json.load(open("../data/data_for_LLM_v2/ir_annotation_v2_for_validate.json", "r", encoding="utf-8"))
    s = generate_llm_chat_data_v2(datas)
