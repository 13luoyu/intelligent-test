...
if __name__ == "__main__":
    ...
    with open("dev_ir.csv", "w", encoding="utf-8") as f:
        f.write(s)
    rules = json.load(open("../data/tc_train_data_all_full.json", "r", encoding="utf-8"))
    s = generate_llm_chat_data(rules)
    with open("train_ir.csv", "w", encoding="utf-8") as f:
        f.write(s)
