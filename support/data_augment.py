...
if __name__ == "__main__":
    ...
    task = paras.task
    if task == "all":
        data_augment_nlpcda("../data/data_for_LLM_encoder/tc_train_data.json", "../data/data_for_LLM_encoder/tc_train_data_augmented.json", paras.nlpcda_size)
        data_augment_nlpcda("../data/data_for_LLM_encoder/tc_train_data_rules.json", "../data/data_for_LLM_encoder/tc_train_data_rules_augmented.json", paras.nlpcda_size)
        data_augment_eda_for_tc("../data/data_for_LLM_encoder/tc_train_data.json", "../data/data_for_LLM_encoder/tc_train_data_augmented.json", paras.eda_tc_size)
        data_augment_eda_for_tc("../data/data_for_LLM_encoder/tc_train_data_rules.json", "../data/data_for_LLM_encoder/tc_train_data_rules_augmented.json", paras.eda_tc_size)
        data_augment_eda_for_sc("../data/data_for_LLM_encoder/sc_train_data.json", "../data/data_for_LLM_encoder/sc_train_data_augmented.json", paras.eda_sc_size)
    elif task == "tc":
        data_augment_nlpcda("../data/data_for_LLM_encoder/tc_train_data.json", "../data/data_for_LLM_encoder/tc_train_data_augmented.json", paras.nlpcda_size)
        data_augment_nlpcda("../data/data_for_LLM_encoder/tc_train_data_rules.json", "../data/data_for_LLM_encoder/tc_train_data_rules_augmented.json", paras.nlpcda_size)
        data_augment_eda_for_tc("../data/data_for_LLM_encoder/tc_train_data.json", "../data/data_for_LLM_encoder/tc_train_data_augmented.json", paras.eda_tc_size)
        data_augment_eda_for_tc("../data/data_for_LLM_encoder/tc_train_data_rules.json", "../data/data_for_LLM_encoder/tc_train_data_rules_augmented.json", paras.eda_tc_size)
        # data_augment_nlpcda("../data/tc_data.json", "../data/tc_train_data_augmented.json", paras.nlpcda_size)
        # data_augment_eda_for_tc("../data/tc_data.json", "../data/tc_train_data_augmented.json", paras.eda_tc_size)
    elif task == "sc":
        data_augment_eda_for_sc("../data/data_for_LLM_encoder/sc_train_data.json", "../data/data_for_LLM_encoder/sc_train_data_augmented.json", paras.eda_sc_size)