...
import json
from transformers import AutoModelForTokenClassification, AutoTokenizer, AutoModelForCausalLM, BitsAndBytesConfig
from peft import PeftConfig, PeftModel
import torch
from encoder_fine_tuning.data_loader import read_dict
import hanlp
import re
...
def token_classification_encoder(tci: list, knowledge, model_path: str, dict_file: str, batch_size: int = 8, sentence_max_length: int = 512):
...
def token_classification_decoder(tci, model_name_or_path, knowledge, print_log=False, use_algorithm=False):
