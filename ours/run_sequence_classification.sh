...
python sequence_classification.py --output_dir ../model/ours --split \  --disable_tqdm True --model ../model/mengzi-bert-base-fin --num_train_epochs 50 --lr_scheduler_type constant --weight_decay 0.001 --train_dataset ../data/sc_train_data_base.json --validate_dataset ../data/sc_validate_data.json

python sequence_classification.py --output_dir ../model/ours --split \  --disable_tqdm True --model ../model/mengzi-bert-base-fin --num_train_epochs 50 --lr_scheduler_type linear --weight_decay 0.001 --train_dataset ../data/sc_train_data_base.json --validate_dataset ../data/sc_validate_data.json

python sequence_classification.py --output_dir ../model/ours --split \  --disable_tqdm True --model ../model/mengzi-bert-base-fin --num_train_epochs 50 --lr_scheduler_type cosine --weight_decay 0.001 --train_dataset ../data/sc_train_data_base.json --validate_dataset ../data/sc_validate_data.json
