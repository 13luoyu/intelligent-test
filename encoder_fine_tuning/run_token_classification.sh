...
# 所有数据增强后训练，规则验证
python token_classification.py --output_dir ./output --split \  --disable_tqdm True --model ../model/pretrained/mengzi-bert-base-fin --num_train_epochs 20 --lr_scheduler_type constant --weight_decay 0.002 --train_dataset ../data/data_for_LLM_v1/tc_train_data_all_full.json --validate_dataset ../data/data_for_LLM_v1/rules.json --learning_rate 2e-5
